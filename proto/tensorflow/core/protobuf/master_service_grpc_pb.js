...
function serialize_tensorflow_MakeCallableRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_master_pb.MakeCallableRequest)) {
    throw new Error('Expected argument of type tensorflow.MakeCallableRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_MakeCallableRequest(buffer_arg) {
  return tensorflow_core_protobuf_master_pb.MakeCallableRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_MakeCallableResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_master_pb.MakeCallableResponse)) {
    throw new Error('Expected argument of type tensorflow.MakeCallableResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_MakeCallableResponse(buffer_arg) {
  return tensorflow_core_protobuf_master_pb.MakeCallableResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_tensorflow_ReleaseCallableRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_master_pb.ReleaseCallableRequest)) {
    throw new Error('Expected argument of type tensorflow.ReleaseCallableRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_ReleaseCallableRequest(buffer_arg) {
  return tensorflow_core_protobuf_master_pb.ReleaseCallableRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_ReleaseCallableResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_master_pb.ReleaseCallableResponse)) {
    throw new Error('Expected argument of type tensorflow.ReleaseCallableResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_ReleaseCallableResponse(buffer_arg) {
  return tensorflow_core_protobuf_master_pb.ReleaseCallableResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_tensorflow_RunCallableRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_master_pb.RunCallableRequest)) {
    throw new Error('Expected argument of type tensorflow.RunCallableRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_RunCallableRequest(buffer_arg) {
  return tensorflow_core_protobuf_master_pb.RunCallableRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_RunCallableResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_master_pb.RunCallableResponse)) {
    throw new Error('Expected argument of type tensorflow.RunCallableResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_RunCallableResponse(buffer_arg) {
  return tensorflow_core_protobuf_master_pb.RunCallableResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MasterServiceService = exports.MasterServiceService = {
  ...
  makeCallable: {
    path: '/tensorflow.grpc.MasterService/MakeCallable',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_master_pb.MakeCallableRequest,
    responseType: tensorflow_core_protobuf_master_pb.MakeCallableResponse,
    requestSerialize: serialize_tensorflow_MakeCallableRequest,
    requestDeserialize: deserialize_tensorflow_MakeCallableRequest,
    responseSerialize: serialize_tensorflow_MakeCallableResponse,
    responseDeserialize: deserialize_tensorflow_MakeCallableResponse,
  },
  // Executes a callable registered with MakeCallable.
  runCallable: {
    path: '/tensorflow.grpc.MasterService/RunCallable',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_master_pb.RunCallableRequest,
    responseType: tensorflow_core_protobuf_master_pb.RunCallableResponse,
    requestSerialize: serialize_tensorflow_RunCallableRequest,
    requestDeserialize: deserialize_tensorflow_RunCallableRequest,
    responseSerialize: serialize_tensorflow_RunCallableResponse,
    responseDeserialize: deserialize_tensorflow_RunCallableResponse,
  },
  // Frees resources associated with a callable registered with MakeCallable.
  releaseCallable: {
    path: '/tensorflow.grpc.MasterService/ReleaseCallable',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_master_pb.ReleaseCallableRequest,
    responseType: tensorflow_core_protobuf_master_pb.ReleaseCallableResponse,
    requestSerialize: serialize_tensorflow_ReleaseCallableRequest,
    requestDeserialize: deserialize_tensorflow_ReleaseCallableRequest,
    responseSerialize: serialize_tensorflow_ReleaseCallableResponse,
    responseDeserialize: deserialize_tensorflow_ReleaseCallableResponse,
  },
};
