...
function serialize_tensorflow_CompleteGroupRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.CompleteGroupRequest)) {
    throw new Error('Expected argument of type tensorflow.CompleteGroupRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_CompleteGroupRequest(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.CompleteGroupRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_CompleteGroupResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.CompleteGroupResponse)) {
    throw new Error('Expected argument of type tensorflow.CompleteGroupResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_CompleteGroupResponse(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.CompleteGroupResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_CompleteInstanceRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.CompleteInstanceRequest)) {
    throw new Error('Expected argument of type tensorflow.CompleteInstanceRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_CompleteInstanceRequest(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.CompleteInstanceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_CompleteInstanceResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.CompleteInstanceResponse)) {
    throw new Error('Expected argument of type tensorflow.CompleteInstanceResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_CompleteInstanceResponse(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.CompleteInstanceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_tensorflow_DeleteWorkerSessionRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.DeleteWorkerSessionRequest)) {
    throw new Error('Expected argument of type tensorflow.DeleteWorkerSessionRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_DeleteWorkerSessionRequest(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.DeleteWorkerSessionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_DeleteWorkerSessionResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.DeleteWorkerSessionResponse)) {
    throw new Error('Expected argument of type tensorflow.DeleteWorkerSessionResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_DeleteWorkerSessionResponse(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.DeleteWorkerSessionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_tensorflow_GetStepSequenceRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.GetStepSequenceRequest)) {
    throw new Error('Expected argument of type tensorflow.GetStepSequenceRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_GetStepSequenceRequest(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.GetStepSequenceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_GetStepSequenceResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.GetStepSequenceResponse)) {
    throw new Error('Expected argument of type tensorflow.GetStepSequenceResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_GetStepSequenceResponse(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.GetStepSequenceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_tensorflow_RecvBufRequest(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.RecvBufRequest)) {
    throw new Error('Expected argument of type tensorflow.RecvBufRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_RecvBufRequest(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.RecvBufRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_tensorflow_RecvBufResponse(arg) {
  if (!(arg instanceof tensorflow_core_protobuf_worker_pb.RecvBufResponse)) {
    throw new Error('Expected argument of type tensorflow.RecvBufResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_tensorflow_RecvBufResponse(buffer_arg) {
  return tensorflow_core_protobuf_worker_pb.RecvBufResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var WorkerServiceService = exports.WorkerServiceService = {
  ...
  // See worker.proto for details.
  deleteWorkerSession: {
    path: '/tensorflow.grpc.WorkerService/DeleteWorkerSession',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_worker_pb.DeleteWorkerSessionRequest,
    responseType: tensorflow_core_protobuf_worker_pb.DeleteWorkerSessionResponse,
    requestSerialize: serialize_tensorflow_DeleteWorkerSessionRequest,
    requestDeserialize: deserialize_tensorflow_DeleteWorkerSessionRequest,
    responseSerialize: serialize_tensorflow_DeleteWorkerSessionResponse,
    responseDeserialize: deserialize_tensorflow_DeleteWorkerSessionResponse,
  },
  // See worker.proto for details.
  registerGraph: {
  ...
  // See worker.proto for details.
  recvBuf: {
    path: '/tensorflow.grpc.WorkerService/RecvBuf',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_worker_pb.RecvBufRequest,
    responseType: tensorflow_core_protobuf_worker_pb.RecvBufResponse,
    requestSerialize: serialize_tensorflow_RecvBufRequest,
    requestDeserialize: deserialize_tensorflow_RecvBufRequest,
    responseSerialize: serialize_tensorflow_RecvBufResponse,
    responseDeserialize: deserialize_tensorflow_RecvBufResponse,
  },
  // See worker.proto for details.
  getStepSequence: {
    path: '/tensorflow.grpc.WorkerService/GetStepSequence',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_worker_pb.GetStepSequenceRequest,
    responseType: tensorflow_core_protobuf_worker_pb.GetStepSequenceResponse,
    requestSerialize: serialize_tensorflow_GetStepSequenceRequest,
    requestDeserialize: deserialize_tensorflow_GetStepSequenceRequest,
    responseSerialize: serialize_tensorflow_GetStepSequenceResponse,
    responseDeserialize: deserialize_tensorflow_GetStepSequenceResponse,
  },
  // See worker.proto for details.
  completeGroup: {
    path: '/tensorflow.grpc.WorkerService/CompleteGroup',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_worker_pb.CompleteGroupRequest,
    responseType: tensorflow_core_protobuf_worker_pb.CompleteGroupResponse,
    requestSerialize: serialize_tensorflow_CompleteGroupRequest,
    requestDeserialize: deserialize_tensorflow_CompleteGroupRequest,
    responseSerialize: serialize_tensorflow_CompleteGroupResponse,
    responseDeserialize: deserialize_tensorflow_CompleteGroupResponse,
  },
  // See worker.proto for details.
  completeInstance: {
    path: '/tensorflow.grpc.WorkerService/CompleteInstance',
    requestStream: false,
    responseStream: false,
    requestType: tensorflow_core_protobuf_worker_pb.CompleteInstanceRequest,
    responseType: tensorflow_core_protobuf_worker_pb.CompleteInstanceResponse,
    requestSerialize: serialize_tensorflow_CompleteInstanceRequest,
    requestDeserialize: deserialize_tensorflow_CompleteInstanceRequest,
    responseSerialize: serialize_tensorflow_CompleteInstanceResponse,
    responseDeserialize: deserialize_tensorflow_CompleteInstanceResponse,
  },
};
