...
goog.object.extend(proto, tensorflow_serving_apis_get_model_metadata_pb);
var tensorflow_serving_apis_inference_pb = require('../../tensorflow_serving/apis/inference_pb.js');
goog.object.extend(proto, tensorflow_serving_apis_inference_pb);
var tensorflow_serving_apis_predict_pb = require('../../tensorflow_serving/apis/predict_pb.js');
goog.object.extend(proto, tensorflow_serving_apis_predict_pb);
